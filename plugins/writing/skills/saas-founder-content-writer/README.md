...
A content editor for SaaS founders, indie hackers, and product builders. It turns what a founder actually knows — product updates, support tickets, technical lessons, usage data, and personal observations — into high-signal posts for X, Reddit, and LinkedIn. It refuses to write generic marketing copy: posts earn attention by being specific, honest, and useful to the reader first.
...
- When you want the same material adapted to X, Reddit, or LinkedIn norms
...
6. Applies platform rules for X, Reddit, and LinkedIn
7. Writes an open that earns the next line

**Phase 4: Review**
8. Scores against a rubric (not-an-ad, specific, angle clear, platform fit, honest, human voice, strong open) and revises
...
Reddit self-promotion rules vary by subreddit; the skill always reminds you to check the target subreddit's rules before posting. The skill never invents metrics, quotes, or results, and never posts on your behalf.
